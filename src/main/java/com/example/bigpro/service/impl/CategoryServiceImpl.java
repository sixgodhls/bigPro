...
import com.example.bigpro.Dao.GoodsCategoryMapper;
import com.example.bigpro.entity.GoodsCategory;
import com.example.bigpro.entity.VO.IndexCategoryVO;
import com.example.bigpro.entity.VO.SecondLevelCategoryVO;
import com.example.bigpro.entity.VO.ThirdLevelCategoryVO;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<IndexCategoryVO> getCategoryForIndex() {
        ...
        //获取一级分类的固定数量的数据
        List<GoodsCategory> firstLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(Collections.singletonList(0L), 1, 10);
